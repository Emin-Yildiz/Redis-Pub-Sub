...
@Service("producEventListener2")
public class ProducEventListener2 implements MessageListener {
    ...
    public ProducEventListener2(ObjectMapper objectMapper, RedisTemplate<String, Object> redisTemplate) {
    ...
    public void onMessage(Message message, byte[] pattern) {
        log.info(String.format("new message received productEventListener2: %s", message.toString()));
        try {
